...
ActiveRecord::Schema.define(version: 20170325021917) do
  ...
  create_table "conversation_invitations", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["conversation_id"], name: "index_conversation_invitations_on_conversation_id", using: :btree
    t.index ["user_id"], name: "index_conversation_invitations_on_user_id", using: :btree
  end
  ...
  create_table "tag_topic_replies", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["tag_topic_id"], name: "index_tag_topic_replies_on_tag_topic_id", using: :btree
    t.index ["user_id"], name: "index_tag_topic_replies_on_user_id", using: :btree
  end
  ...
  create_table "tag_topics", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string   "slug"
    t.index ["slug"], name: "index_tag_topics_on_slug", unique: true, using: :btree
    t.index ["tag_id"], name: "index_tag_topics_on_tag_id", using: :btree
    t.index ["user_id"], name: "index_tag_topics_on_user_id", using: :btree
  end
  ...
  add_foreign_key "conversation_invitations", "conversations"
  add_foreign_key "conversation_invitations", "users"
  ...
  add_foreign_key "tag_topics", "users"
